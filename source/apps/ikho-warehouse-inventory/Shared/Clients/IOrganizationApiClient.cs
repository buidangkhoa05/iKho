...
/// <summary>The subset of the Organization service's warehouse data that Inventory needs.</summary>
...
/// (<c>ikho-warehouse-organization</c>), used to validate that a bin referenced by a stock
/// operation actually exists and is currently active.
/// </summary>
