...
public sealed class CatalogApiClient(HttpClient httpClient) : ICatalogApiClient
{
    ...
    public async Task<CatalogProductInfo?> GetProductAsync(Guid productId, CancellationToken cancellationToken)
    {
        ...
        return product is null
            ? null
            : new CatalogProductInfo(product.Id, product.Sku, product.IsLotControlled, product.IsSerialControlled, product.IsActive);
    }
    ...
    /// break this client.
    /// </summary>
    private sealed record CatalogProductResponseShape(Guid Id, string Sku, bool IsLotControlled, bool IsSerialControlled, bool IsActive);
}
