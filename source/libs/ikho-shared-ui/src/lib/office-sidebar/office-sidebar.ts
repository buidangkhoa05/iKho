...
export class OfficeSidebar {
  ...
  private static readonly ITEM_DEFAULT = 'bg-transparent text-shade-60 hover:bg-canvas-light hover:text-ink';
  private static readonly ITEM_ACTIVE = 'bg-primary text-on-primary';

  protected readonly navClasses = computed(() =>
    [
      'box-border flex h-full flex-col justify-between overflow-y-auto border-r border-hairline-light bg-surface-elevated-light py-4 px-3 transition-[width] duration-[180ms] ease-standard',
